...
public class GzipGsonProvider<T> implements MessageBodyReader<T>, MessageBodyWriter<T> {

  private final Gson gson;

  public GzipGsonProvider() {
    gson = new Gson();
  }
  ...
  {
    try( InputStreamReader reader = new InputStreamReader( new GZIPInputStream( entityStream ), UTF_8 ) ) {
